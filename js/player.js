...
var mediaProviders = getUrlParam("mediaProviders") || "WebRTC,Flash,MSE,WSPlayer";
// we are not getting stream name directly form url 
// var streamName = getUrlParam("streamName") || "streamName";
var streamName = '9dd26af5';
var urlServer = "wss://app.qwyet.com:8443";

function initStreamName(){
    $.ajax({
        url: "https://qwyet.com/api/stream", 
